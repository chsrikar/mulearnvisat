                            ...
                            >
                                ...
                                >
                                    <button
                                        ...
                                        className={cn(
                                            'group relative w-full overflow-hidden py-3.5 rounded-xl font-semibold text-sm text-white transition-all duration-300 cursor-pointer border-none',
                                            'bg-gradient-to-r from-primary-700 to-accent-700',
                                    ...
                                    >
                                        {/* Expanding circle */}
                                        <span className="absolute h-0 w-0 rounded-full bg-primary-600 transition-all duration-500 ease-out group-hover:h-[28rem] group-hover:w-[28rem]" />
                                        {/* Left wave SVG */}
                                        <span className="absolute bottom-0 left-0 -ml-2 h-full">
                                            <svg xmlns="http://www.w3.org/2000/svg" className="h-full w-auto opacity-100" viewBox="0 0 487 487">
